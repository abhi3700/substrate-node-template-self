...
//! Autogenerated weights for pallet_eosio_system
//!
...
/// Weight functions needed for pallet_eosio_system.
pub trait WeightInfo {
	fn dummy() -> Weight;
}

/// Weights for pallet_eosio_system using the Substrate node and recommended hardware.
